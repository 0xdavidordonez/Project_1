...
btc_df = pd.read_csv('Resources/BTC-USD_daily.csv', index_col='Date', parse_dates=True, infer_datetime_format=True)
...
venax_df = pd.read_csv('Resources/VENAX_daily2.csv', index_col='Date', parse_dates=True, infer_datetime_format=True)
venax_df.head()
